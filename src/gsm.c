...
void PrepareGSM(char *cmdline, struct GsmConfig_t *config)
{
    ...
    static const predef_vmode_struct predef_vmode[29] = {
        ...
        {GS_NONINTERLACED, GS_MODE_DTV_480P,    GS_FRAME, makeDISPLAY(479,  1099, 0,   1,   35,  232), makeSYNCV(6,  483,  3072, 30,  0,   6)},
        ...
        {GS_NONINTERLACED, GS_MODE_DTV_480P,    GS_FRAME, makeDISPLAY(479,  1099, 1,   2,   35,  500), makeSYNCV(6,  483,  3072, 30,  0,   6)},
